...
const RentModal = () => {
  ...
  let bodyContent = (
    <div className="flex flex-col gap-8">
      <Heading
        title="Whish of these best describes your place?"
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="help guest find your place"
        />
        <CountrySelect
          value={location}
  ...
  if (step === STEPS.IMAGES) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Add images to your place"
          subtitle="Show what guest what your place looks like!"
        />
        <ImageUpload
          value={imageSrc}
  ...
  if (step === STEPS.PRICE) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Now, what is the price of your place?"
